...
#' 
#' @details 
#' This function performs cokrig-and-regress (CNR) on spatially misaligned data, where the continuous response is spatially misaligned with multiple correlated continuous covariates. 
