...
#' 
#' @details 
#' This function perform l-nearest-matching-and-regress (l-NMR) on spatially misaligned data, where the continuous response is spatially misaligned with multiple covariates. 
